...
#define DELTA
  ...
  #define DELTA_SEGMENTS_PER_SECOND 175
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80, 80, 80, 520}  // default steps per unit for Kossel (GT2, 20 tooth)
#define DEFAULT_MAX_FEEDRATE          {500, 500, 500, 30}    // (mm/sec)
